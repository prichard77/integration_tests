...
def test_host_comparison_security():
    ...
    Polarion:
        ...
        testSteps:
            ...
            5. Click "Apply"
            *If the displayed rows do not have any items (item count is '(0)') the next steps do not apply.
            6. If the security rows/sections have sub-items, click on one of the security row items (Users, Groups, ...).
        ...
        expectedResults:
            ...
            5. New rows should be displayed in the compare host/node view for all security items (Users, Groups,
...
def test_host_comparison_configuration():
    ...
    Polarion:
        ...
        testSteps:
            ...
            5. Click "Apply"
            *If the displayed rows do not have any items (item count is '(0)') the next steps do not apply.
            6. If the configuration rows/sections have sub-items, click on one of the configuration row items (OS,
            Guest Applications, ...).
        ...
        expectedResults:
            ...
            5. New rows should be displayed in the compare host/node view for all configuration items (OS, Guest
...
def test_host_comparison_my_company_tags():
    ...
    Polarion:
        ...
        testSteps:
            ...
            5. Click "Apply"
            *If the displayed rows do not have any items (item count is '(0)') the next steps do not apply.
            6. If the "My Company Tags" rows/sections have sub-items, click on one of the "My Company Tags" row items
            (Department, Customer, ...).
        ...
        expectedResults:
            ...
            5. New rows should be displayed in the compare host/node view for all "My Company Tags" items (Department,
